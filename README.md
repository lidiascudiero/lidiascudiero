...
| **[NeuroPsy-Research Archive](https://github.com/lidiascudiero/neuropsy-research-archive)** | **Behavioral Data Modeling.** Mapping clinical traits to cognitive performance and body perception. | **PsyToolkit**, SPSS, Excel. <br> **Models:** Posner Cueing, Memory Tasks, LCSQ, AST. | Engineered **automated scoring** for clinical scales and validated **BMI-based** behavioral correlations. |
---
